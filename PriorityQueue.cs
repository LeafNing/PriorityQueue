...
namespace LDAG
{
    ...
    public class PriorityQueue1<T> where T : IComparable<T>
    {
        ...
        public void up(int n)
        {
            ...
            {
                n1 = (n - 1) >> 1;
                if (data[heap[n1]].CompareTo(temp)>=0) break;
                heap[n] = heap[n1];
                index[heap[n]] = n;
                n = n1;
            }
        ...
        public void down(int n)
        {
            ...
            while ((n << 1) + 1 < count)
            {
                ...
                int n2 = n1 + 1;
                //int n3 = (n2 < count && data[heap[n2]] > data[heap[n1]]) ? n2 : n1;
                int n3 = (n2 < count && data[heap[n2]].CompareTo(data[heap[n1]])>0) ? n2 : n1;
                if (data[heap[n3]].CompareTo(temp)<=0) break;
                heap[n] = heap[n3];
                index[heap[n]] = n;
                n = n3;
            }
        ...
        public PriorityQueue1(int n, T theta)
        {
            heap = new int[n];
            data = new T[n];
            index = new int[n];
        ...
        public void push(int key, T value)
        {
            data[key] = value;
            //Console.WriteLine("key = " + key + " count = " + count);
            heap[count++] = key;
